...
class	CtmCurveEx: public CtmWnd
{
	...
	public:
	  ...
	  void    OnLoseFocus();			
		...
		void	SetMonitorAttr(CURVEPOINT 	*pValue1, CURVEPOINT *pValue2, int nLineWidth=2,int nColor=0x134F,int nReference=0, BOOL bUsed=TRUE);
	...
	private:
		...
		int		GetLastTop();
		int		GetLastBottom();
		BOOL	CheckMonitorCoordinateChange();
