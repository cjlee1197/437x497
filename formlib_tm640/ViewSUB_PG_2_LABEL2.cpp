...
BOOL	OnCreateA(CtmWnd* pwndSender)
{
	...
	SelectNo		=GetDBValue("SYSX_OTHERS_OTHERS_INT_RESERVED51").lValue; // ≈™®˙®B∆J
	u_SubGroup = GetDBValue("SYSX_OTHERS_OTHERS_INT_RESERVED47").lValue; // ≈™®˙∞∆µ{¶°Ωs∏π
