...
int			SelectNo	=0;
long		ActionType  =0;
int			EditNUM=0,ACTIONPARA1=0,ACTIONPARA2=0,ACTIONPARA3=0,ACTIONPARA5=0;
		...
		if(pwndSelectEditNUM->Is("CtmSelectEdit"))
		{
			...
			if(ActionType==1)
			{
				...
				if(pwndStaticPreDistance != NULL)
				{
					...
					else if(EditNUM ==4)	//C軸  三軸
					//else if(EditNUM ==6)	//C軸  五軸
					{
...
//					}
	...
	if(pwndEditACTIONPARA2 != NULL)			//統杅2
	{
...
void	OnUpdateA(CtmWnd* pwndSender)
{
	...
	if(pwndStaticPreDistance != NULL && (ActionType==1)&&(SelectNo>=SandbyStepNum)) // hotkey 移動軸
	{
