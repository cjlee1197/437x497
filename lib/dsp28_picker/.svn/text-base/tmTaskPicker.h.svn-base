#ifndef		D__TMTASKPICKER_V01
#define		D__TMTASKPICKER_V01
#include	"../../taskhost.h"
#include	"../../main.h"
#include	"../../ethnet.h"
//	0: CTask
...
const	int		CONST_REQ_ACTUAL2		=17;		//J.W	add 	2014/8/27 8:59:34
...
const	int		CONST_RES_ACTUAL2		=1017;
...
#define		DSP28PROTOCOL_HEADER_CONTEXT_S	0x5588
#define		DSP28PROTOCOL_FOOTER_CONTEXT_S	0x1166
#define   BLOCK_PICKER_RECIPE_ID      437
#define   BLOCK_PICKER_MACHINE_ID     438
...
class  CtmTaskPicker: public CTaskHost
{
	DECLARE_DYNCREATE(CtmTaskPicker)
	public:
		CtmTaskPicker();
		~CtmTaskPicker();
	public:
	...
	private:
		...
		//	the static variants
		//====================
	    static	CtmTaskPicker*		m_pSelf;				//	指向本身的指針  
...
#ifndef	D_BEOBJECT_CTMTASKPICKER	//	defineName=D_BEOBJECT_+CASE(ClassName) 
