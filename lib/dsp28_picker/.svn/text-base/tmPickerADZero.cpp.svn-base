#include	"../../tmdebug.h"
#include	"tmPickerADZero.h"


IMPLEMENT_DYNCREATE(CtmPickerADZero, CtmProtocol)

CtmPickerADZero::CtmPickerADZero(): CtmProtocol()
{
	
}

CtmPickerADZero::~CtmPickerADZero()
{
	
}


int		CtmPickerADZero::CreateSelf()
{
...
int		CtmPickerADZero::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	int		nResult = 0;
...
int		CtmPickerADZero::ParseProtocol(void* pInData,		int nInputLen)
{
