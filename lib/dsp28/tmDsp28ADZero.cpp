#include	"../../tmdebug.h"
#include	"tmDsp28ADZero.h"


IMPLEMENT_DYNCREATE(CtmDsp28ADZero, CtmProtocol)

CtmDsp28ADZero::CtmDsp28ADZero(): CtmProtocol()
{
	
}

CtmDsp28ADZero::~CtmDsp28ADZero()
{
	
}


int		CtmDsp28ADZero::CreateSelf()
{
...
int		CtmDsp28ADZero::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	int		nResult = 0;
...
int		CtmDsp28ADZero::ParseProtocol(void* pInData,		int nInputLen)
{
...
#ifndef	D_BEOBJECT_CTMDSP28ZERO
