#include	"../../tmdebug.h"
#include	"../../database.h"
#include	"tmDsp28Alarm.h"
#include	"../../tmcontrol.h"
#include	"../../utils.h"


IMPLEMENT_DYNCREATE(CtmDsp28Alarm, CtmDsp28Protocol)

CtmDsp28Alarm::CtmDsp28Alarm(): CtmDsp28Protocol()
{
	
}

CtmDsp28Alarm::~CtmDsp28Alarm()
{
	
}


int		CtmDsp28Alarm::CreateSelf()
{
...
int		CtmDsp28Alarm::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
...
int		CtmDsp28Alarm::ParseProtocol	(void* pInData,		int nInputLen)
{
