#include	"../../tmdebug.h"
#include	"tmDsp28Temper.h"


IMPLEMENT_DYNCREATE(CtmDsp28Temper, CtmProtocol)

CtmDsp28Temper::CtmDsp28Temper(): CtmProtocol()
{
	
}

CtmDsp28Temper::~CtmDsp28Temper()
{
	
}


int		CtmDsp28Temper::CreateSelf()
{
...
int		CtmDsp28Temper::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	int		nResult = 0;
...
int		CtmDsp28Temper::ParseProtocol	(void* pInData,		int nInputLen)
{
