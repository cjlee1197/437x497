#include	"../../tmdebug.h"
#include	"tmDsp28MoldsetStatus.h"


IMPLEMENT_DYNCREATE(CtmDsp28MoldsetStatus, CtmDsp28Protocol)

CtmDsp28MoldsetStatus::CtmDsp28MoldsetStatus(): CtmDsp28Protocol()
{
	
}

CtmDsp28MoldsetStatus::~CtmDsp28MoldsetStatus()
{
	
}


int		CtmDsp28MoldsetStatus::CreateSelf()
{
...
int		CtmDsp28MoldsetStatus::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	int		nResult = 0;
