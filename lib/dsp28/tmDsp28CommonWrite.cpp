#include	"../../tmdebug.h"
#include	"../../database.h"
#include	"tmDsp28CommonWrite.h"


IMPLEMENT_DYNCREATE(CtmDsp28CommonWrite, CtmDsp28Protocol)
IMPLEMENT_DYNCREATE(CtmDsp28CommonDiagWrite, CtmDsp28CommonWrite)

CtmDsp28CommonWrite::CtmDsp28CommonWrite(): CtmDsp28Protocol()
{
	
}

CtmDsp28CommonWrite::~CtmDsp28CommonWrite()
{
	
}


int		CtmDsp28CommonWrite::CreateSelf()
{
...
int		CtmDsp28CommonWrite::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	//printf("nInputLen=%d \n", nInputLen);
...
int		CtmDsp28CommonWrite::ParseProtocol	(void* pInData,		int nInputLen)
{
...
CtmDsp28CommonDiagWrite::CtmDsp28CommonDiagWrite(): CtmDsp28CommonWrite()
{
	
}

CtmDsp28CommonDiagWrite::~CtmDsp28CommonDiagWrite()
{
	
}

int		CtmDsp28CommonDiagWrite::CreateSelf()
{
	CtmProtocol::CreateSelf();
...
int	CtmDsp28CommonDiagWrite::ComposeProtocol(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	if (nInputLen == 0 || pInData == NULL)		return 0;
