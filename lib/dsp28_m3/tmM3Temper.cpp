#include	"../../tmdebug.h"
#include	"tmM3Temper.h"


IMPLEMENT_DYNCREATE(CtmM3Temper, CtmProtocol)

CtmM3Temper::CtmM3Temper(): CtmProtocol()
{
	
}

CtmM3Temper::~CtmM3Temper()
{
	
}


int		CtmM3Temper::CreateSelf()
{
...
int		CtmM3Temper::ComposeProtocol	(void* pOutData,	void* pInData, int nInputLen, void* pEx)
{
	int		nResult = 0;
...
int		CtmM3Temper::ParseProtocol	(void* pInData,		int nInputLen)
{
